    ...
    public function updateNotifications(int $userId, array $data): bool
    {
        try {
            $query = "UPDATE notification_settings SET 
                        ...
                        vibration_notifications = :vibration_notifications,
            ...
            $result = $stmt->execute([
                ...
                'desktop_notifications' => isset($data['desktop_notifications']) ? 1 : 0,
                'sound_notifications' => isset($data['sound_notifications']) ? 1 : 0,
                'vibration_notifications' => isset($data['vibration_notifications']) ? 1 : 0,
                'vehicle_alerts' => isset($data['vehicle_alerts']) ? 1 : 0,
                'maintenance_reminders' => isset($data['maintenance_reminders']) ? 1 : 0,
                'intervention_updates' => isset($data['intervention_updates']) ? 1 : 0,
                'team_notifications' => isset($data['team_notifications']) ? 1 : 0,
                'system_alerts' => isset($data['system_alerts']) ? 1 : 0,
                'report_generation' => isset($data['report_generation']) ? 1 : 0,
                'notification_frequency' => $data['notification_frequency'] ?? 'realtime',
                'quiet_hours_enabled' => isset($data['quiet_hours_enabled']) ? 1 : 0,
    ...
    private function createNotificationSettings(int $userId, array $data): bool
    {
        try {
            $query = "INSERT INTO notification_settings (
                        ...
                        desktop_notifications, sound_notifications, vibration_notifications,
